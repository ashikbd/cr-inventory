<div class="row">
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              @endif
              <form method="post" action="{{ url('admin/stock/stockout_update') }}">
                @csrf
                <div class="form-group">
                  <label>Reference No</label>
                  <input type="text"  name="reference_no" value="{{ $stock->reference_no }}" class="form-control">
                </div>
                <div class="form-group">
                        ...
                        <tr>
                            ...
                            <td class="expiry_date">
                                <select name="expiry_date[]" class="form-control">
                                    <option value="{{ $item->expiry_date }}" selected>{{ $item->expiry_date }}</option>
                                </select>
                            </td>
                ...
                <div class="form-group float-right">
                  <a href="{{ url('admin/stock/stockout_list') }}" class="btn btn-default">Back</a>
